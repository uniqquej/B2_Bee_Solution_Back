...
urlpatterns = [
    ...
    path('<int:article_id>/detail/', views.ArticleDetailView.as_view(), name = 'detail_article'),
    ...
    path('<int:article_id>/comment/<int:comment_id>/likes/', views.CommentLikeView.as_view(), name = 'comment_like'),
