...
from users.serializers import UserSerializer, UserCreateSerializer, CustomTokenObtainPairSerializer, UserprofileSerializer
...
class UserAuthView(APIView):
    ...
    def post(self, request):
        ...
        # try except 로 오브젝트로 묶어서 한번에 처리하기
